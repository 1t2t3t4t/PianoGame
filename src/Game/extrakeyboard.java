...
public class extrakeyboard extends JLayeredPane{
	...
	private void initialize() {
		...
		shape1.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) { 
				shape1.setBackground(Color.orange);
				keyReleased("e");
				}
		});
		shape1.setBackground(Color.orange);
		...
		shape2.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseReleased(MouseEvent e) { 
				shape2.setBackground(Color.green);
				keyReleased("r");
				}
		});
		shape2.setBackground(Color.green);
		...
		shape3.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseReleased(MouseEvent e) { 
				shape3.setBackground(Color.darkGray);
				keyReleased("y");
				}
		});
		shape3.setBackground(Color.darkGray);
		...
		shape4.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseReleased(MouseEvent e) { 
				shape4.setBackground(Color.gray);
				keyReleased("u");
				}
		});
		shape4.setBackground(Color.gray);
		...
		shape5.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseReleased(MouseEvent e) { 
				shape5.setBackground(Color.magenta);
				keyReleased("i");
				}
		});
		shape5.setBackground(Color.magenta);
